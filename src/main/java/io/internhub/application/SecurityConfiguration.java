    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .csrf().disable()
                ...
                .antMatchers("/jobs/**").access("((hasRole('INTERN') or hasRole('EMPLOYER')) and hasRole('ISAPPROVED')) or hasRole('ADMIN')")
                .antMatchers("/interns/applied-index", "/interns/index", "/interns/profile/**").access("hasRole('INTERN') and hasRole('ISAPPROVED')")
